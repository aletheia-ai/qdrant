...
DOWNLOAD_LINK=$(curl --silent "https://api.github.com/repos/aletheia-ai/qdrant-web-ui/releases/latest" | jq -r '.assets[] | select(.name=="dist-qdrant.zip") | .browser_download_url')
